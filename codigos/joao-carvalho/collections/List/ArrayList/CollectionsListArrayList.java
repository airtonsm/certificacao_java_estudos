...
public class CollectionsListArrayList{
	...
	public static List<Integer> ListOfInteger; 
	...
	public static void main(String [] args){
		...
		switch (menuManager.ShowMenu(10)){
			case 1: 
				printTests(ListOfStrings,ListOfInteger,capitalCities, unorderedArrNumeric);
				break;
		}	
	} 
	...
	public static void printTests(List<String> ListOfStrings, List<Integer> ListOfInterger,String [] strings, Integer [] unorderedArrNumeric){
		
		//https://docs.oracle.com/javase/7/docs/api/java/util/Arrays.html#asList(T...)
		List<String> listOfStrings = new ArrayList<String>(Arrays.asList(strings));
		ArrayList<Integer> listOfInteger = new ArrayList<Integer>(Arrays.asList(unorderedArrNumeric));
		
		listOfInteger.ensureCapacity(15);
		
		System.out.println("The inserted order is maintained\n");
		...
		/*Like using an object of this interface to performactions on each element of this vector
		 *It seems like the elements of the vector are not affected.
		 *Functional Interfaces are the one the have only one method. So this method can be referenced as lambda expressions*/		 
		System.out.println("Calling in ArrayList an  implemented method java.util.(interface)Iterable<T>.forEach(Consumer<? super T> action)  ::: "); 
