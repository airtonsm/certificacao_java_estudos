...
public class CollectionsQueueAbstractQueue{
	...
	//class LinkedList implements Queue using FIFO policy for add(), poll()
	public static void LinkedListImplementation(String [] strings, Integer [] integers){
			System.out.println("Printing methods of LinkedList: ";
