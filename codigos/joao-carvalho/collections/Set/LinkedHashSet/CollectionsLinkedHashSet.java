...
public class CollectionsLinkedHashSet{
	...
	public static void PrintAllTreeSet(Set<String> SetOfStrings, String [] strings, Integer [] numericarr){
		...
		SetOfStrings = new LinkedHashSet<String>(Arrays.asList(strings));
		
		System.out.println("The inserted order is maintained even in the hashing cycle(when the hash table is turn bigger): \n");
		
		System.out.println("The Strings added weren't reordered: "+SetOfStrings);
		
		System.out.println("");
		
		LinkedHashSet numericalTreeSet = new LinkedHashSet(Arrays.asList(numericarr));
		
		System.out.println("The Integers added weren't ordered: "+numericalTreeSet);
